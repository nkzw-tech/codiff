...
test('markdown images trigger CodeView layout remeasurement after load', async () => {
  ...
  try {
    ...
    const images = app.container.querySelectorAll<HTMLImageElement>('.codiff-markdown-image');
